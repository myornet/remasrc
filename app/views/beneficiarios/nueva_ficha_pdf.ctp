...
if($beneficiario['Beneficiario']['estado'] == 0):

	$PDF->linea[0] = array(
				'posx' => $L1[0],
				'ancho' => 190,
				'texto' => "*** NO VIGENTE *** " . $util->armaFecha($beneficiario['Beneficiario']['fecha_baja']),
				'borde' => '',
				'align' => 'L',
				'fondo' => 1,
				'style' => 'B',
...
$PDF->linea[1] = array(
			'posx' => 35,
			'ancho' => 165,
			'texto' => $beneficiario['Persona']['condicion_ocupacion_actual_d'],
			'borde' => 'TBLR',
			'align' => 'L',
			'fondo' => 1,
			'style' => 'B',
...
$PDF->linea[1] = array(
			'posx' => 40,
			'ancho' => 65,
			'texto' => ($beneficiario['Persona']['vivienda_precaria'] == 1 ? "SI":"NO"),
			'borde' => 'TBLR',
			'align' => 'L',
			'fondo' => 1,
			'style' => 'B',
...
$PDF->linea[3] = array(
			'posx' => 125,
			'ancho' => 75,
			'texto' => ($beneficiario['Persona']['nbi'] == 1 ? "SI":"NO"),
			'borde' => 'TBLR',
			'align' => 'L',
			'fondo' => 1,
			'style' => 'B',
...
//IMPRIMO LAS OBSERVACIONES DEL TITULAR
if(!empty($beneficiario['Persona']['observaciones'])):
	$PDF->ln(1);
	...
	$PDF->MultiCell(0,0,str_replace("\n","",$beneficiario['Persona']['observaciones']),1,'L');
	$PDF->SetFontSizeConf($fontSizeBody);
endif;
...
if(!empty($beneficiario['adicionales'])):
	...
	foreach($beneficiario['adicionales'] as $adicional):
		...
		$PDF->linea[0] = array(
					'posx' => 10,
					'ancho' => 190,
					'texto' => $adicional['Persona']['tdocndoc'] . " - " . $adicional['Persona']['apenom'] . ($adicional['BeneficiarioAdicional']['estado'] == 0 ? " *** BAJA EL ".$util->armaFecha($adicional['BeneficiarioAdicional']['fecha_baja'])."***" : ""),
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[3] = array(
					'posx' => 80,
					'ancho' => 22,
					'texto' => $adicional['Persona']['cuit_cuil'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[5] = array(
					'posx' => 122,
					'ancho' => 78,
					'texto' => (!empty($adicional['BeneficiarioAdicional']['fecha_alta']) ? $util->armaFecha($adicional['BeneficiarioAdicional']['fecha_alta']) : ""),
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[3] = array(
					'posx' => 142,
					'ancho' => 58,
					'texto' => $adicional['Persona']['tipo_nivel_instruccion_d'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[1] = array(
					'posx' => 35,
					'ancho' => 165,
					'texto' => $adicional['Persona']['tipo_ocupacion_oficio_d'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[3] = array(
					'posx' => 175,
					'ancho' => 25,
					'texto' => $util->nf($adicional['Persona']['ingresos']),
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[1] = array(
					'posx' => 35,
					'ancho' => 165,
					'texto' => $adicional['Persona']['institucion_anio_grado_d'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->linea[1] = array(
					'posx' => 35,
					'ancho' => 165,
					'texto' => $adicional['Persona']['tipo_cobertura_medica_d'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 1,
					'style' => 'B',
		...
		$PDF->Imprimir_linea();	
		if(!empty($adicional['Persona']['observaciones'])):
			$PDF->ln(1);
			...
			$PDF->Imprimir_linea();
			$PDF->SetFontSizeConf(7);
			$PDF->MultiCell(0,0,str_replace("\n","",$adicional['Persona']['observaciones']),0,'L');
			$PDF->SetFontSizeConf($fontSizeBody);
		endif;			
