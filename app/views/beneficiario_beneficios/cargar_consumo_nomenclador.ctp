	...
	<table class="tbl_form">
		<tr>
			...
			<tr>
				...
				<td><?php echo $this->renderElement('combo_nomenclador',array('plugin' => 'global','model' => 'BeneficiarioBeneficioDetalle','field' => 'codigo_producto', 'selected' => (isset($this->data['BeneficiarioBeneficioDetalle']['codigo_producto']) ? $this->data['BeneficiarioBeneficioDetalle']['codigo_producto'] : "")))?></td>
			</tr>
